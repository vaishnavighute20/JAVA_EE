...
/**
 *  if voter is not voted control comes here
...
public class CandidateListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter pw = response.getWriter()) {
			...
			// get clnt details from the HttpSession which is existing
			...
			if (user != null) {
				...
				List<Candidate> candidateList = dao.getAllCandidates();// candilatelist servlet is calling candidate dao metod
