...
public ModelAndView RenderDynamicResult() {
	...
	/*
	 * Handler returning ModelAndView to D.S
	 * D.S send LVN--> V.R-->AVN(/WEB-INF/views/test/display.jsp-->D.S
	 * adds model attribute/ under request scope 
	 * D.S forwards the cliect to jsp
	 */
