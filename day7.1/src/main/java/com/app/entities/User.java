...
@Entity // class level , run time anno for hibernate to manage the entities(i.e life
		// cycle) : mandatory
@Table(name="users") //for specifying table name  and if we doesnot provide table name it will take class name as table  name
public class User {
	...
	// hibernate can not alter table to modify or delete existing column  but it insert in column 
